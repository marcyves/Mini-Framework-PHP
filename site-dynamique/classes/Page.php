...
class Page
{
    ...
    public function __construct($page = "home", $theme = "html5up-massively", $template= "index", $dossier_controleurs = "controleurs", $dossier_themes = "themes")
    {
        $this->theme               = $theme;
    ...
    public function setDossierControleurs($dossier_controleurs)
    {
        $this->dossier_controleurs = $dossier_controleurs;
    }
    ...
    public function remplaceLabel($label, $texte)
    {
